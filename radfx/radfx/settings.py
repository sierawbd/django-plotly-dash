...
ROOT_URLCONF = 'radfx.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'radfx', 'templates'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'radfx.wsgi.application'

ASGI_APPLICATION = 'radfx.routing.application'
...
PLOTLY_DASH = {
    ...
    "stateless_loader" : "radfx.scaffold.stateless_app_loader",
    }
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'radfx', 'static'),
    ]
