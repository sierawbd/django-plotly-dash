...
import radfx.plotly_apps    # pylint: disable=unused-import
import radfx.dash_apps      # pylint: disable=unused-import
import radfx.bootstrap_app  # pylint: disable=unused-import
...
urlpatterns = [
    ...
    path('solarcycle/', include('solarcycle.urls')),
    path('ionStopping/', include('ionStopping.urls')),
    path('geomag/', include('geomag.urls')),
    path('xs/', include('xs.urls')),
    path('bendel/', include('bendel.urls')),
